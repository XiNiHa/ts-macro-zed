...
const TS_PLUGIN_PACKAGE_NAME: &str = "@ts-macro/typescript-plugin";
...
impl zed::Extension for TsmExtension {
    fn new() -> Self {
        Self {
    ...
    fn language_server_initialization_options(
        ...
        let initialization_options = LspSettings::for_worktree("ts-macro", worktree)
            .ok()
